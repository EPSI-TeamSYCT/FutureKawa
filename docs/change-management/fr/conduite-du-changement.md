...
> 📸 **[SCREENSHOT]** — Tableau de bord du siège, Brésil sélectionné, entrepôt wh-01
> ouvert, un lot EN ALERTE avec sa courbe de température/humidité sortant de la plage
> verte.
...
> 📸 **[SCREENSHOT]** — Zone KPI/synthèse du tableau de bord du siège : stocks par pays
> et nombre d'alertes actives côte à côte pour le Brésil, l'Équateur et la Colombie.
