  ...
  [
    {
      ...
      children: [
        ...
        {
          path: 'lots/:id',
          lazy: async () => ({ Component: (await import('@/pages/LotDetail')).LotDetail }),
        },
        {
          path: 'entrepots',
          lazy: async () => ({ Component: (await import('@/pages/Entrepots')).Entrepots }),
        },
        {
          path: 'entrepots/:id',
          lazy: async () => ({
            Component: (await import('@/pages/EntrepotDetail')).EntrepotDetail,
          }),
        },
        {
          path: 'alertes',
          lazy: async () => ({ Component: (await import('@/pages/Alertes')).Alertes }),
        },
        {
          path: 'parametres',
    ...
    },
    {
      ...
      lazy: async () => ({
        Component: (await import('@/pages/ComponentsGallery')).ComponentsGallery,
      }),
    },
  ],
  {
